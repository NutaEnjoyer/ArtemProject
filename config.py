...
получишь от меня приятный бонус за подписку в виде эксклюзивной фотосессии или видео 🔥</i>""", resources = " • 👑 ЭКСКЛЮЗИВ VIP - канал"
    ...
    Tariff(
        title = "🔞 ВИРТ", price = 900, price_usd =20, about = """<b>Дорогой, мы можем провести Вирт в совершенно разных вариантах: 😛</b>
...
- созвониться по видео""", resources = " • 🔞 ВИРТ - канал"
    ...
    Tariff(
        title = "🎁 ВСЕ ТАРИФЫ", price = 1800, price_usd =20, about = """<i>вступай сразу в 3 vip канала, чтобы было больше меня 💦

тут все мои тайные эксклюзивные и3вращени9, много контента, который регулярно пополняется</i>
контент заставит тебя думать только обо мне 💭 а п0рн0 контент 🔞 говорит за себя только название, как жестко же меня в нём трах… 💦 

<i>получишь от меня приятный бонус за подписку в виде эксклюзивной фотосессии или видео 🔥</i>""", resources = """ • ⭐️ ПРОБНЫЙ VIP - канал
• 🔥 ПРЕМИУМ VIP - канал
• 👑 ЭКСКЛЮЗИВ VIP - канал"""
        ),
]
